...
#Answer:
# This program asks the user a question and checks if their answer is correct. It uses .lower() to ignore capital letters, making the answer check flexible and user-friendly.
